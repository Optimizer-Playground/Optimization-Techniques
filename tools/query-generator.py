...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=100,
        help="The number of queries to generate. Defaults to 100.",
    )
    parser.add_argument(
        "--min-tables",
        type=int,
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=[],
        help="Tables that should not be included in the queries. "
    ...
    pg_instance = (
        pb.postgres.connect(connect_string=args.db_connect)
        if args.db_connect
    ...
    qgen = sampler.generate_query(
        pg_instance,
        count_star=count_star,
        ignore_tables=ignored_tables,
