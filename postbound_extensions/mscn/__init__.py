...
MSCN implements the PostBOUND
`CardinalityEstimator <https://postbound.readthedocs.io/en/latest/prototyping.html#cardinality-estimation>`__
...
- We do not using the few-hot encoding scheme for the filter operators. Instead,
  ...
  additional predicate types such as *LIKE*.
...
- We (currently) **do not support bitmap samples** to refine the encoding of base tables.
...
also provide an *online* mode which does not leak any information from the training
...
of the
`Optimizer Collection project <https://github.com/Optimizer-Playground/Optimization-Techniques>`_.
...
.. [Kipf2019] Andreas Kipf et al.:
   "Learned Cardinalities: Estimating Correlated Joins with Deep Learning" (CIDR 2019);
   https://vldb.org/cidrdb/papers/2019/p101-kipf-cidr19.pdf
