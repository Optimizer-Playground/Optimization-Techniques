"""Bao is a learned query optimizer/cost model.

It predicts *optimizer hints* (DBMS settings that modify the optimizer behavior) to generate faster
query plans.
...
Some parts are reused from the
`TreeConvolution project <https://github.com/RyanMarcus/TreeConvolution>`__
by Ryan Marcus. Likewise, we also take inspiration from the
`reference implementation for PostgreSQL <https://github.com/learnedsystems/BaoForPostgreSQL>`__,
...
(see Deviations from the Original Paper below for details).
...
After studying the `reference implementation <https://github.com/learnedsystems/BaoForPostgreSQL>`__
...
from the `TreeConvolution project <https://github.com/RyanMarcus/TreeConvolution>`__
by Ryan Marcus, which is licensed under GPL-3.0 terms.
The implementation is provided as part of the
`Optimizer Collection project <https://github.com/Optimizer-Playground/Optimization-Techniques>`__
and licensed under the terms of the GPL-3.0.

References
-----------

.. [Marcus2021] Ryan Marcus et al.: "Bao: Making Learned Query Optimization Practical"
...
.. TreeConvolution project: https://github.com/RyanMarcus/TreeConvolution
"""
